...
public class Account {
	...
	// TODO: Task3 
	// replace the null with a lambda expression
	public static AddMaker maker =  (int number)->{ Consumer<Account> a = add -> add.balance += number; return a;};
	...
	public static int getMaxAccountID(List<Account> accounts) {
		// TODO: Task4 
		// replace the null with a lambda expression
		Account maxOne = accounts.stream().reduce(new Account(0, -100), (s1,s2)->s1.balance>s2.balance?s1:s2 );
