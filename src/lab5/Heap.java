...
public class Heap<T extends Comparable<T>> {
    ...
    public T peek() {
    	...
    	else{ return container.get(0);} // replace this line with implementation
    }
    ...
    private void heapifyUp() {
        ...
        while ((this.hasParent(pos)) && (container.get(pos).compareTo(container.get(getParentIndex(pos))) < 0)) {
